...
import com.project.navigation.menu.home.HomeFragment;
import com.project.navigation.menu.message.MessageFragment;
import com.project.navigation.menu.notification.NotificationFragment;
import com.project.navigation.menu.search.SearchFragment;
...
//        navigationView.setItemIconTintList(null); //disable tint on each icon to use color icon svg
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.menu_profile) {
            Toast.makeText(this, "Hi shahin", Toast.LENGTH_SHORT).show();
